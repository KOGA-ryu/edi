...
| --- | --- | --- | --- | --- | --- |
| dungeon-map-20260619-provingground | edi-dungeon-map | closeout | COMPLETE ✅ (NEUTRAL proving-ground map + Seam B TOON export; M1 8f240b5 / M2 68e3b94 / M3 1f93288 / M4 a5a4f13). ⚠️ TWO PRE-EXISTING drafting-core issues: (1) 7-test Release-build SEGFAULT — ✅ FIXED by dept/drafting D03/D05 merge (8e1e5b6): bare assert() elided under NDEBUG; replaced with non-eliding EDI_CHECK + lint guard; Release ctest now 121/121. (2) --export-map CLI teardown abort — partially addressed by D04 headless offscreen fallback (d990313); leave for HUB triage. The deferred lock twin is now delivered by cleanup-d15-d18 below. | [docs/handoffs/dungeon-map-20260619-provingground.md](dungeon-map-20260619-provingground.md) | edi-dungeon-map-planner |
| dungeon-map-20260619-cleanup-d15-d18 | edi-dungeon-map | closeout | COMPLETE ✅ — ✅ MERGED to master by HUB cleanup-wave. Cleanup D15 (Seam B/C lock-tag parity) + D18 (determinism-test scope). All gates green: reviewer ✅ (D15→Option A full parity, D18→Option b) builder ✅ S1 b6a5b24 / S2 8fc0a25 / S3 0102b79 / S4 5f14e37 / S5 3d02f9e. Dept-verified Debug 118/118; HUB re-verified post-merge Debug + Release BOTH 121/121 (the 7 old segfaults stay fixed; dungeon-map's new test assertions converted from bare assert() to EDI_CHECK during merge to satisfy the lint + Release safety). NEW Seam C golden (no-cols + locked round-trip); Seam B golden UNCHANGED (6c632293). Closeout: docs/closeouts/dungeon-map-lock-tag-seam-parity.md. Supersedes the proving-ground deferred twin. | [docs/handoffs/dungeon-map-20260619-cleanup-d15-d18.md](dungeon-map-20260619-cleanup-d15-d18.md) | edi-dungeon-map-planner |
...
| dungeon-map-20260619-provingground | [docs/closeouts/dungeon-map-proving-ground.md](../closeouts/dungeon-map-proving-ground.md) | 2026-06-19 (merged to master @8da3bdb) |
