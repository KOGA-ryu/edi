...
| **Blender recipe lab / script composer** | **Blender workspace** (Right Palette\|Render\|Compiled + bottom Steps\|Editor\|ASCII); click the Palette to chain steps, the Steps inspector to tune them | **missing** | ◐ (click-compose works; field-type coverage + binding picker next) |
