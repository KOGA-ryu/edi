...
int main()
{
    ...
    assert(plan.penStats[0].objectCount == 1);
    ...
    assert(hiddenInkPlan.layerStats.size() == 1);
    assert(hiddenInkPlan.layerStats.front().layerId == "default");
    assert(hiddenInkPlan.penStats.size() == 1);
    assert(hiddenInkPlan.penStats.front().penId == "pen_black");
