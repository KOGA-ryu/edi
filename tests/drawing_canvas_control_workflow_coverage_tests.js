...
function runRecommendedSelectorContract(repoRoot) {
    ...
    for (const recommendation of recommendedSelectors) {
        ...
        expect(failureCommand.length > 0, `${id} should include failureCommand`)
        ...
        expect(failureCommand.indexOf("--compare-baseline") >= 0, `${id} failureCommand should compare baselines`)
